# Fibonacci Retracement Stock Indicator Tool [fibRetracement.py]
# Purpose:      This program aims to demonstrate Python's distinguishing features, control structures, and recursive capabilities through
#               a tool that produces the Fibonacci sequence, calculates key ratios from the sequence, processes historical stock data from a file,
#               analyzes the stock data for high and low prices, runs stock data through Fibonacci Retracement using the calculated ratios, and
#               displays a console price chart with indicator levels.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      [Global] {fibCount, cachedFibCount}
# Dependencies:     {os.path, sys, csv, dateutil.parser, math, functools.lru_cache, time}
# Creation Date:    04 October 2020
# Revision:         1.3
# Revision Date:    06 October 2020
# Sources:          N/A
...
# Main [main()]
# Purpose:      This subprogram controls the program run, interfacing with the user for input, validating data existence,
#               and calling each function as necessary.  It outputs program status to the user through the program's execution.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      [Global] {fibCount, cachedFibCount}
#                   [Local]  {run, found, ticker, filename, stockData, fibN, start, end, Fibonacci, Fibonacci2, keyRatios, levels}
# Dependencies:     {os.path, sys, time}
# Creation Date:    04 October 2020
# Revision:         1.3
# Revision Date:    06 October 2020
# Sources:          N/A
def main():
    ...
    if run:
        ...
        min, max = findPriceExtrema(stockData)             # Find the highest and lowest prices in the data
...
# Parse CSV Stock Data[parseStockDataCSV(filename)]
# Purpose:      This subprogram opens a CSV file of stock data and stores the contained information as a list, returning the list data.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      {Parameter/Argument] {filename}
#                   [Local]  {Stock_Data, stockData}
# Dependencies:     {csv}
# Creation Date:    04 October 2020
# Revision:         1.1
# Revision Date:    05 October 2020
# Sources:          N/A
...
# Fibonacci (n)th Number [Fib(n)]
# Purpose:      This subprogram recursively determines and returns the (n)th number of the Fibonacci Sequence.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      {Parameter/Argument] {n}
#                   [Global]  {fibCount}
# Dependencies:     N/A
# Creation Date:    04 October 2020
# Revision:         1.1
...
# Fibonacci (n)th Number (Cached) [Fib_Cached(n)]
# Purpose:      This subprogram recursively determines and returns the (n)th number of the Fibonacci Sequence, using a cache to limit re-computation.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      {Parameter/Argument] {n}
#                   [Global]  {cachedFibCount}
# Dependencies:     {functools.lru_cache}
...
# Generate Fibonacci Sequence [buildFibonacciSequence(n,function)]
# Purpose:      This subprogram generates the Fibonacci sequence to (n) places, calling a function to determine each individual index.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      {Parameter/Argument] {n, function}
#                   [Local]  {Fibonacci,f}
# Dependencies:     N/A
# Creation Date:    04 October 2020
# Revision:         1.0
# Revision Date:    04 October 2020
# Sources:          N/A
...
# Calculate Key Fibonacci Ratios [calcKeyFibRatios(Fibonacci,ratios)]
# Purpose:      This subprogram calculates the key ratios derived from the Fibonacci Sequence.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      {Parameter/Argument] {Fibonacci, ratios}
#                   [Local]  {fibRatios, i, a, total, r}
# Dependencies:     N/A
# Creation Date:    04 October 2020
# Revision:         1.1
# Revision Date:    05 October 2020
...
# Find Price Extrema (High/Low) [findPriceExtrema(quoteData)]
# Purpose:      This subprogram finds and returns the maximum (high) and minimum (low) prices in the available data.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      {Parameter/Argument] {quoteData}
#                   [Local]  {min, max, low, high, pr}
# Dependencies:     N/A
# Creation Date:    04 October 2020
# Revision:         1.1
# Revision Date:    05 October 2020
# Sources:          N/A
def findPriceExtrema(quoteData):
...
# Calculate Fibonacci Retracement Indicator Levels [calcIndicatorLevels(periodHigh,periodLow,ratios)]
# Purpose:      This subprogram calculates and returns a list containing the Fibonacci Retracement indicator levels on the available stock data.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      {Parameter/Argument] {periodHigh, periodLow, ratios}
#                   [Local]  {diff, levels, r}
# Dependencies:     N/A
# Creation Date:    04 October 2020
# Revision:         1.0
...
# Chart Stock Price with Indicator Levels [chartStockPrice(max,min,quoteData,levels,ticker)]
# Purpose:      This subprogram uses the calculated stock data to draw a console price chart, including the Fibonacci Retracement indicator levels.
# Author:           Nathaniel Kren
# Language          Python 3.7.0
# Interpreter:      Python 3.7.0 Interpreter
# Identifiers:      {Parameter/Argument] {max, min, quoteData, levels, ticker}
#                   [Local]  {chart, rows, cols, r, c, row, date, p, open, close, openRow, closeRow, rng, lvl, lvlRow}
# Dependencies:     {math, dateutil.parser}
# Creation Date:    04 October 2020
# Revision:         1.4
# Revision Date:    06 October 2020
# Sources:          N/A
